...
// export default function URLDetailsCard(props: {
//   data: URLInterface;
//   client_id: string;
// }) {
...
//         .delete(API_URL + "/url/delete?" + params)
//         .then((res) => res.data)
//         .catch((err) => {
...
//                   <p className="text-lg ml-2">{props.data.url}</p>
//                 </div>
//                 <div className="flex flex-row">
...
//             <a
//               href={
//                 "/client/" + props.client_id + "/form/url/" + props.data.url
//               }
//             >
...
export default function URLDetailsCard() {
  return (
    <div>URLDetailsCard</div>
  )
}
